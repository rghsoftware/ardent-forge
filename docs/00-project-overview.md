...
The system maintains a clear separation between what a program _prescribes_ and what the user _actually did_. This enables meaningful progress tracking — you can see whether you hit the prescribed reps, exceeded them, or fell short.
...
| `03-prd-hosting.md`         | Self-hosting and runtime backend configuration         |
| `04-prd-events.md`          | Event session type and packing list requirements       |
...
| `12-prd-chat.md`            | In-app messaging, workout sharing, and media (post-v1) |
