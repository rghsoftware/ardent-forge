...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card flex flex-col gap-6 overflow-hidden bg-surface-iron py-6 text-sm text-bone-white data-[size=sm]:gap-4 data-[size=sm]:py-4',
        className,
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-sm text-warm-ash', className)}
      {...props}
    />
  )
}
