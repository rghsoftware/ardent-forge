...
pub fn run() {
    tauri::Builder::default()
        .setup(|app| {
            ...
            app.manage(event_reminder::EventReminderState::new());
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::workout_logs::delete_logged_set,
            commands::workout_logs::delete_logged_activity,
            commands::workout_logs::delete_logged_activity_group,
            ...
            commands::programs::delete_week_statuses,
            // User profile
            ...
            commands::notification::schedule_event_reminders,
            commands::notification::cancel_event_reminders,
            // Sharing
